...
export class LoginComponent implements OnInit{
  ...
  validateCASTicket(ticket: string) {
    this.isValidating = true;
    const validateUrl = `${environment.casValidateUrl}?ticket=${ticket}&service=${environment.backUpUrl}/login`;
  ...
  goToCAS() {
    window.location.href = `${environment.casLoginUrl}?service=${environment.backUpUrl}/login`;
  }
}